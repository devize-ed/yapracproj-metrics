...
func (s *StubRepository) Save(gauge map[string]float64, counter map[string]int64) error {
	return nil // No-op for stub
}

// Load returns empty maps for the stub repository.
func (s *StubRepository) Load() (map[string]float64, map[string]int64, error) {
